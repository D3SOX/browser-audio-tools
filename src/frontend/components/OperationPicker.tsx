    ...
    <section className="section">
      ...
      <div className="radio-group">
        <label className={`radio-card ${operation === "noise" ? "selected" : ""}`}>
          <input type="radio" name="operation" value="noise" checked={operation === "noise"} onChange={() => onChange("noise")} />
        ...
        <label className={`radio-card ${operation === "cover" ? "selected" : ""}`}>
          <input type="radio" name="operation" value="cover" checked={operation === "cover"} onChange={() => onChange("cover")} />
          <div className="radio-card-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <label className={`radio-card ${operation === "retag" ? "selected" : ""}`}>
          <input type="radio" name="operation" value="retag" checked={operation === "retag"} onChange={() => onChange("retag")} />
          <div className="radio-card-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
