...
export function CoverArtPicker({ previewUrl, inputId, onChange }: CoverArtPickerProps) {
    ...
    <div className="cover-art-container">
      ...
      <div className="cover-art-preview">
        ...
        <input
          ...
          id={inputId}
        />
        <label htmlFor={inputId} className="cover-art-edit-btn" title="Change cover art">
